...
HD_PWD='C:/Users/sleep/Projects_vivado/handsOn_basys3_hlsm_soda/handsOn_basys3_hlsm_soda.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log soda_machine_seg10_sb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source soda_machine_seg10_sb.tcl -notrace
