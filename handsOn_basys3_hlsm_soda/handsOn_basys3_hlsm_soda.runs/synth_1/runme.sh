...
HD_PWD='C:/Users/sleep/Projects_vivado/handsOn_basys3_hlsm_soda/handsOn_basys3_hlsm_soda.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soda_machine_seg10_sb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soda_machine_seg10_sb.tcl
