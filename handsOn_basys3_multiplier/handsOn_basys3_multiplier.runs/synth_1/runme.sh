...
HD_PWD='C:/Users/sleep/handsOn_basys3_multiplier/handsOn_basys3_multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_multipler_sb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seq_multipler_sb.tcl
