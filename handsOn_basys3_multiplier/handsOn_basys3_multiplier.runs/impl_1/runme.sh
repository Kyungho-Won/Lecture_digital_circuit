...
HD_PWD='C:/Users/sleep/handsOn_basys3_multiplier/handsOn_basys3_multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_multipler_sb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seq_multipler_sb.tcl -notrace
