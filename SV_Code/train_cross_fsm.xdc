...
## Switches
set_property PACKAGE_PIN V17 [get_ports {TRE}]
	set_property IOSTANDARD LVCMOS33 [get_ports {TRE}]
...
#set_property PACKAGE_PIN U1 [get_ports {ALU_Sel[0]}]
...
set_property PACKAGE_PIN R2 [get_ports {TRW}]
	set_property IOSTANDARD LVCMOS33 [get_ports {TRW}]


## LEDs
set_property PACKAGE_PIN U16 [get_ports {GATE}]
...
#set_property PACKAGE_PIN L1 [get_ports {CarryOut}]
...
#set_property PACKAGE_PIN U2 [get_ports {Segment_Sel[0]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {Segment_Sel[0]}]
#set_property PACKAGE_PIN U4 [get_ports {Segment_Sel[1]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {Segment_Sel[1]}]
#set_property PACKAGE_PIN V4 [get_ports {Segment_Sel[2]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {Segment_Sel[2]}]
#set_property PACKAGE_PIN W4 [get_ports {Segment_Sel[3]}]
	#set_property IOSTANDARD LVCMOS33 [get_ports {Segment_Sel[3]}]
