...
## LEDs
set_property PACKAGE_PIN U16 [get_ports {tot[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {tot[0]}]
set_property PACKAGE_PIN E19 [get_ports {tot[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {tot[1]}]
set_property PACKAGE_PIN U19 [get_ports {tot[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {tot[2]}]
set_property PACKAGE_PIN V19 [get_ports {tot[3]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {tot[3]}]
set_property PACKAGE_PIN W18 [get_ports {tot[4]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {tot[4]}]
set_property PACKAGE_PIN U15 [get_ports {tot[5]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {tot[5]}]
set_property PACKAGE_PIN U14 [get_ports {tot[6]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {tot[6]}]
set_property PACKAGE_PIN V14 [get_ports {tot[7]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {tot[7]}]
