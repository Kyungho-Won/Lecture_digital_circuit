...
HD_PWD='C:/Users/sleep/Projects_vivado/handsOn_basys3_seq/handsOn_basys3_seq.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mod10_counter_sb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mod10_counter_sb.tcl
