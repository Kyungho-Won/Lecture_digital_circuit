...
HD_PWD='C:/Users/sleep/Projects_vivado/handsOn_basys3_seq/handsOn_basys3_seq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mod10_counter_sb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mod10_counter_sb.tcl -notrace
